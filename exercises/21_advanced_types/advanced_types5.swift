...
// TODO: Conform this type to the `Nameable` and `Talking` protocols
//  with as few symbols in this declaration as possible.
struct Person {
	// TODO: Implement `name` to conform to `Nameable`

	// TODO: Implement `talk(_:)` to conform to `Talking` that returns a string like: "John: I can Talk!"
}
